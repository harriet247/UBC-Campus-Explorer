...
const InsightEndpoint_1 = require("./InsightEndpoint");
    ...
    start() {
        ...
        return new Promise(function (fulfill, reject) {
            try {
                ...
                that.rest.put("/dataset/:id/:kind", InsightEndpoint_1.default.addDataset(that.insightFacade));
                that.rest.del("/dataset/:id", InsightEndpoint_1.default.removeDataset(that.insightFacade));
                that.rest.get("/datasets", InsightEndpoint_1.default.listDataset(that.insightFacade));
                that.rest.post("/query", InsightEndpoint_1.default.performQuery(that.insightFacade));
